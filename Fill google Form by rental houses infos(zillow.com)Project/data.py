...
#Get all adress of elements
all_adress_elements = soup.select('.list-card-info address')
all_adress = [adress.get_text().split(' | ')[-1] for adress in all_adress_elements]

#Get All price of elements
